  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | Cool Cuts</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Cool Cuts in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Cool Cuts | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="Cool Cuts | Premium Barbershop Berlin" />
        <meta
